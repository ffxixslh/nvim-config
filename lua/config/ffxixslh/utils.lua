...
local ffxixslhGroup = vim.api.nvim_create_augroup("FfxixslhGroup", { clear = true })

M.config_autocmd = function(event, opts)
  vim.api.nvim_create_autocmd(event, vim.tbl_extend("force", opts, { group = ffxixslhGroup }))
end
